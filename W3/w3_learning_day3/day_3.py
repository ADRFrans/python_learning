...
#Example - you can use the range() function to c reate an iterable: 
newlist = [x for x in range(10)]

#Example 
newlist = [x for x in range(10) if x < 5]

#Example - set the values in the new list to upper cas e
newlist = [x.upper() for x in fruits]

#Exampel - set all values in the new list to 'hello'
